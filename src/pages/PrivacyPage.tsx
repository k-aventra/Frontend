      ...
      <section className="section-band tone-1 legal-page">
        <div className="wrap legal-doc">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Privacy Policy) refers to {COMPANY_LEGAL_NAME}.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                from the Service infrastructure itself (for example, the duration
                of a page visit).
              </p>
            </li>
            <li>
              <p>
                <strong>Website</strong> refers to {BRAND_DOMAIN}, accessible from{' '}
                <a
                  href={BRAND_URL}
          ...
          <p>
            ...
            withdraw or change Your consent at any time using Our cookie
            preferences tool (if available) or through Your browser/device
          ...
          <ul>
            ...
            <li>
              ...
              a limited period consistent with our backup retention schedule and
              are not restored except where necessary for security, disaster
