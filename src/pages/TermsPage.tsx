...
export function TermsPage() {
  return (
    <SiteLayout>
      <section className="section-band tone-1 legal-page">
        <div className="wrap legal-doc">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in these Terms and Conditions) refers to {COMPANY_LEGAL_NAME}.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                any documents expressly incorporated by reference, which govern
                Your access to and use of the Service and form the entire
            ...
            <li>
              <p>
                <strong>Website</strong> refers to {BRAND_DOMAIN}, accessible
                from{' '}
                <a
                  href={BRAND_URL}
          ...
          <p>
            ...
            collect, use, and disclose personal information. Please read Our
          ...
          <p>
            ...
            Service or 100 USD if You haven&apos;t purchased anything through
            the Service.
          </p>
          <p>
